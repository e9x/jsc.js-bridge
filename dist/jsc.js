...
class Server extends Host {
	...
	create_module(){
		...
		__webpack_require__(/*! ../build-wasm/out/jsc.js?emcc */ "../build-wasm/out/jsc.js?emcc")(Module);
	}
};
