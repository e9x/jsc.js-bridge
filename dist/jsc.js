...
var current = typeof document == 'object' && document.currentScript ? document.currentScript.src : 'https://e9x.github.io/jsc.js-bridge/dist/',
	Host = __webpack_require__(/*! ./Host */ "./Host.js");
	...
	create_module(){
		this.Module = {
			postRun: async () => {
				...
				this.Module.eval(await(await fetch(new URL("jsc.client.js", current))).text());
...
/******/ 	
/******/ })()
;typeof module=="object"?(module.exports=JSC):globalThis.JSC=JSC;